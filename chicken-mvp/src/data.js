    ...
    cards: [
      {
        ...
        qBtn: { label: '계약 취소하면 돈 돌려받을 수 있어? →', target: null },
      },
      {
        title: '인테리어',
        hint: '본사 지정업체 강제',
        ...
        qBtn: { label: '6,500에 본사 마진 30%가 포함됐다고? →', target: null },
      },
      {
        title: '장비/설비',
        hint: '주방 장비 일체',
        ...
        qBtn: { label: '3년마다 또 수천만이 나간다고? →', target: null },
      },
      {
        title: '숨겨진 비용',
        hint: '보증금 + 예비금',
  ...
  s9: {
    ...
    cards: [
      ...
      },
      {
        ...
        qBtn: { label: '혼자 다 하면 1~2년 안에 번아웃 온다고? →', target: null },
      },
      {
        title: '임대료',
        hint: '20평 평균',
        ...
        qBtn: { label: '임대 50만 차이가 순이익을 반으로 만든다고? →', target: null },
      },
      {
        title: '실제 순이익',
        hint: '모든 비용 제외 후',
        ...
        qBtn: { label: '직원 한 명 더 쓰면 남는 게 없다고? →', target: null },
      },
    ],
  },
  s13: {
    ...
    cards: [
      {
        ...
        qBtn: { label: '오픈하고 나면 입지는 못 바꾼다고? →', target: null },
      },
      {
        title: '자금 소진',
        hint: '초기 운영 위기',
      ...
      },
      {
        ...
        qBtn: { label: '그만두고 싶어도 못 나온다고? →', target: null },
      },
      {
        title: '번아웃 폐업',
        hint: '체력·정신 소모',
